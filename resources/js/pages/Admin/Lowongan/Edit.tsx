...
interface LowonganEditProps {
    lowongan: Lowongan;
}

export default function LowonganEdit({ lowongan }: LowonganEditProps) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        alamat: lowongan.alamat,
        telepon: lowongan.telepon,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        router.post(route('admin.lowongan.update', lowongan.id), data);
    };
        ...
        <AppLayout breadcrumbs={[]}>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-3xl font-bold tracking-tight">Edit Lowongan Pekerjaan</h1>
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Form Edit Lowongan</CardTitle>
                        <CardDescription>Perbarui data lowongan pekerjaan dalam sistem.</CardDescription>
                    </CardHeader>

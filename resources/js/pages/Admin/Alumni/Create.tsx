        ...
        <AppLayout breadcrumbs={[]}>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-3xl font-bold tracking-tight">Tambah Alumni</h1>
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Form Alumni</CardTitle>
                        <CardDescription>Tambahkan data alumni baru ke dalam sistem.</CardDescription>
                    </CardHeader>
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div className="space-y-2 md:col-span-2">
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        Upload foto dengan ukuran maksimal 2MB. Format yang didukung: JPG, PNG, GIF.
                                    </p>

...
export function SiteFooter() {
    return (
        <footer className="from-primary/5 via-muted/50 to-primary/5 border-t bg-gradient-to-br px-6 py-12">
            <div className="container">
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-3">
                                ...
                                <span className="text-muted-foreground text-sm">
                                    WJF7+MF8, Borong, Kec. Tanralili, Kabupaten Maros, Sulawesi Selatan 90553
                                </span>
                            </li>
                            <li className="flex items-center gap-3">
                                <Phone className="text-primary h-5 w-5" />
                                <span className="text-muted-foreground text-sm"> 0813-4276-1975</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <Mail className="text-primary h-5 w-5" />
                                <span className="text-muted-foreground text-sm">info@sman5maros</span>
                            </li>
                            <li className="flex items-center gap-3">
                ...
                <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t pt-6 md:flex-row">
                    <p className="text-muted-foreground text-sm">&copy; {new Date().getFullYear()} SMAN 5 Maros. Hak Cipta Dilindungi.</p>
                    <div className="flex gap-4">
                        <Link href="#" className="text-muted-foreground hover:text-primary text-sm transition-colors">
                            Kebijakan Privasi
                        </Link>
